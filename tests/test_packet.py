...
def test_packet_rectangle_svg():
    packet = Packet(
        rectangle=Rectangle(coordinates=RectangleCoordinates(wsen=[0, 0, 0]))
    )
    print(packet._repr_svg_())


def test_packet_point_svg():
    packet = Packet(
        point=Point(color=Color(rgba=[255, 0, 0, 255])),
